...
import CreateUserCustomer from "./pages/UserCustomer/CreateUserCustomer";
import UpdateUserCustomer from "./pages/UserCustomer/UpdateUserCustomer";
        ...
        <Routes>
          ...
          >
            ...
            <Route element={<LayoutAdmin />}>
              ...
              <Route path="/customer/create" component={CreateUserCustomer} />
              <Route
                path="/customer/update/:id"
                component={UpdateUserCustomer}
              />
